...
public class LoggingAspect {
	 ...
	 * @param jp
	 */
	@Before("PointcutBundle.controllerPointcut()") // PointcutBundle 클래스의 controllerPointcut() 소환
	...
	public Object aroundServiceImpl(ProceedingJoinPoint pjp) throws Throwable { // Exception(예외 - 개발자가 처리할수 있는 문제), Error(오류 - 시스템 레벨의 개발자가 못건드리는 문제)의 부모객체 Throwable
	...
	public void transactionalRollback(JoinPoint jp, Throwable ex){
