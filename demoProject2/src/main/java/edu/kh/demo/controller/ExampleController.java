...
public class ExampleController {
	...
	public String ex1(HttpServletRequest req, Model model) {
		...
		req.setAttribute("test1", "HttpServletRequest로 전달할 값");
	...
	public String ex2(Model model) {// model ( = data 전달용 객체)
	...
	@GetMapping("ex3/{path}") //{path}에 변수명이 입력이 됨 
	public String pathVariableTest(@PathVariable("path") int path) {
		...
		// controller단의 메서드에서 사용할수 있도록 해줌
		// + request scope 자동 세팅
